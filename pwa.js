...
const cacheName = 'extraXPFixit7KyleKidder-2020-10-17 14:41:09.387156'; // unique value, generated each deploy
  ...
  e.waitUntil(
    caches.keys().then((keyList) => {
      ...
      return Promise.all(keyList.map((key) => {
        ...
        if (cacheName.indexOf(key) === -1  && key.substr(0, 'extraXPFixit7KyleKidder'.length) === 'extraXPFixit7KyleKidder') {
